...
public class BBSDAO {
	...
	public static int insert(BBSVO vo) {
	...
	public static void hitCreate(int b_idx) {
		
		SqlSession ss = DBService.getFactory().openSession(true);
		ss.update("bbs.hitUpdate", b_idx);
		ss.close();
		
	}
	
	public static void delete(int b_idx) {
		
		SqlSession ss = DBService.getFactory().openSession(true);
		ss.delete("bbs.delete", b_idx);
		ss.close();
		
	}
	
	public static void update(BBSVO vo) {
		
		SqlSession ss = DBService.getFactory().openSession(true);
		ss.update("bbs.updateAll", vo);
		ss.close();
